...
LambdaHg1s,LambdaHg2s=546.074,345.834
...
print('H平均值:',np.mean(R_H))
print('H平均误差:',np.std(R_H))
print('D平均值:',np.mean(R_D))
print('D平均误差:',np.std(R_D))
massRatio=R_D_mean/R_H_mean/(1-M/m*(R_D_mean/R_H_mean-1))#质量比
print('质量比：',massRatio)
print('H波数',WNH_C)
print('D波数',WND_C)
